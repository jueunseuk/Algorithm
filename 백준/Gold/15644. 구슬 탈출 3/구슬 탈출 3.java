...
public class Main {
    ...
    static class State {
        ...
        public State(int rx, int ry, int bx, int by, int dist, String history) {
            this.rx = rx;
            this.ry = ry;
            this.bx = bx;
            this.by = by;
        ...
        while(!queue.isEmpty()){
            ...
            for(int i = 0; i < 4; i++){
                ...
                if(redHole && !blueHole) {
                	...
                	System.out.println(cur.history+dd[i]);
                	return;
                }
                ...
                if(!visit[rnx][rny][bnx][bny]) {
                    ...
                    queue.offer(new State(rnx, rny, bnx, bny, cur.dist+1, cur.history+dd[i]));
                }
            }
        }
